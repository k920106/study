...
export default function Navbar() {
	...
	return (
			<nav
					// className="h-20 border border-b-gray-20 w-full shadow-sm p-4 sm:px-10 flex justify-between align-center fixed top-0 bg-white">
					className={cn(
							...
							{
								'!h-44': showFilter,
								'!items-start': showFilter,
							},
					)}
			>
				<div
						className="grow basis-0 hidden my-auto font-semibold text-lg sm:text-xl text-rose-500 cursor-pointer sm:flex sm:gap-2">
					<MdModeOfTravel className="text-4xl my-auto"/>
					<div className="my-auto">Nextbnb</div>
				</div>
				{!showFilter ? (
						<div
								className="w-full sm:w-[280px] border border-gray-200 rounded-full shadow hover:shadow-lg cursor-pointer flex justify-between pl-6 pr-2">
						...
						<div className="sm:w-[340px] cursor-pointer w-full relative">
							...
							<div
									className="w-[90%] sm:max-w-3xl flex flex-col sm:flex-row border border-gray-200 rounded-lg py-4 sm:py-2 sm:rounded-full shadow-sm bg-white hover:shadow-lg cursor-pointer justify-between fixed top-20 inset-x-0 mx-auto">
...
const LocationFilter = ({
	...
	return (
			<div
					className="absolute top-80 sm:top-[70px] border border-gray-200 px-8 py-10 flex flex-col bg-white w-full mx-auto inset-x-0 sm:max-w-3xl sm:w-[780px] rounded-xl">
