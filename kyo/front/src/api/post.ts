...
export { createPost, getPost, getPosts, deletePost, updatePost, getFavoritePosts, updateFavoritePost, getSearchPosts, getCalendarPosts };
// export type { ResponsePost, RequestCreatePost, ResponseSinglePost, RequestUpdatePost };
export type { ResponsePost, RequestCreatePost, ResponseSinglePost, RequestUpdatePost, CalendarPost, ResponseCalendarPost };